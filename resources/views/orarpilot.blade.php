...
<div class='d-flex flex-row'>
      ...
      <div class="d-flex justify-content-between" >
        ...
        <a href="/orarpilot?delta={{$ref-1}}" class='btn btn-lg btn-info my-4'>Luna Anterioara</a>
        <h4>Luna {{$luna_curenta+1}}</h4>
        <a href="/orarpilot?delta={{$ref+1}}" class='btn btn-lg btn-info my-4'>Luna Urmatoare</a>
      </div>
